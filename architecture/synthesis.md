...
There are two kinds of gaps. **Preset gaps** are persistent and always present — they are never filled, only continually acted on. These include gap finding, alignment, memory management, research, and testing. All other gaps emerge from the gap finding process and are filled by drones as normal.
